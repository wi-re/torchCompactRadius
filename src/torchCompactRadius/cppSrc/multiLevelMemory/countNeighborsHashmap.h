...
auto countNeighborsHashmap_getFunctionArguments(bool useCuda, countNeighborsHashmap_functionArguments_t){
	...
	return std::make_tuple(countNeighborsHashmap_arguments_t);
}
...
deviceInline auto countNeighborsHashmap_impl(int32_t i, countNeighborsHashmap_computeArguments_t) {
